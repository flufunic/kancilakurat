...
<head>
    ...
    <title>Upload DIPA - SantriKoding.com</title>
                    ...
                    <div class="card-body">
                        <form action="{{ route('dipas.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" value="{{ old('nama') }}" placeholder="Masukkan Nama DIPA">
